...
// Si se pasa un argumento, simplemente devuélvelo
  // Tu código:
  if (arguments.length === 0) return 0; // Si no hay argumentos, devuelve 0
  if (arguments.length === 1) return arguments[0]; // Si hay un solo argumento, devuélvelo
